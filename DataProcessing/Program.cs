...
namespace QuantConnect.DataProcessing
{
    ...
    public class Program
    {
        ...
        public static int Main()
        {
            ...
            {
                Log.Error(err, $"The downloader/converter for {QuiverWikipediaDataDownloader.VendorDataName} {QuiverWikipediaDataDownloader.VendorDataName} data failed to be constructed");
                return 1;
            }
            ...
            {
                Log.Error(err, $"The downloader/converter for {QuiverWikipediaDataDownloader.VendorDataName} {QuiverWikipediaDataDownloader.VendorDataName} data exited unexpectedly");
                return 1;
            }
            finally
            {
